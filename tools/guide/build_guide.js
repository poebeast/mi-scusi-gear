...
${steps([['Иконка', 'пассивка и её уровень. <b>Клик</b> поднимает уровень, <b>правая кнопка</b> опускает, по кругу. Наведение — описание. Янтарный значок — максимальный доступный уровень, так по умолчанию; белый — уровень выставлен вручную.'], ['Бирюзовая точка', 'пассивка из книги (Fighter’s / Archer’s / Magician’s Will). У них в круг уровней добавлено «не выучена» — на значке тогда «—».'], ['Серая иконка', 'сейчас не работает: нужно другое оружие или броня. Причина есть в подсказке.']])}
...
${steps([['Attacker', 'атакующий — персонаж, выбранный вверху страницы.'], ['Target', 'цель — любой другой класс.'], ['Swap', 'поменять атакующего и цель местами.'], ['Position / Soulshot / Spiritshot / Charges / Distance', 'позиция, заряды, уровень зарядов силовых и звуковых умений (1–8) и дистанция до цели — последняя появляется, когда в руках лук. Сбоку и сзади выше и урон, и шанс крита, и меткость; щит блокирует только спереди.'], ['Строка цели', 'защита, HP и CP цели и итоговые множители зарядов. Заточка оружия даёт +0,7% к заряду за уровень.'], ['Гир цели', 'переодевай цель прямо здесь: клик по слоту открывает то же окно выбора вещи.'], ['Уровень, тату, Buffs, Clan skills цели', 'всё, что влияет на её защиту.']])}
...
${toggle('Что учитывается и что нет', '<p><b>Учитывается:</b> P. Atk./M. Atk. и защиты обеих сторон, шанс и сила крита (включая магический), PvP-бонусы, заряды и множитель заточки оружия, блок щитом и идеальный блок, сопротивление магии, уклонение от умений, позиция, игнор защиты, заряды силовых и звуковых умений, шанс прохождения ударов кинжалом, дистанция выстрела из лука, Skill Mastery и откат умений.</p><p><b>Пока нет:</b> атрибуты (огонь/вода…), заточка умений, дебаффы на цели, урон питомцев, регенерация.</p>')}
