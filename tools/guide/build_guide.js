...
${steps([['Hit / Crit', 'урон обычного удара и крита. Average — средний с учётом шанса крита, промахов и блока.'], ['Cycle', 'как часто можно бить этим умением: большее из перезарядки и времени применения.'], ['DPS', 'урон в секунду, если бить только этим. Таблица отсортирована по нему.'], ['CP+HP in', 'за сколько секунд эта строка в одиночку снимет цели весь CP и HP.'], ['Rotation', 'лучшая связка: в каждый момент бьём самым сильным готовым умением, а пока всё на перезарядке — обычными атаками. Под названием — сколько раз за минуту используется каждое умение. Её DPS и «CP+HP in» — самые близкие к реальному бою.'], ['Серая строка', 'умение недоступно с текущим оружием: «needs a dagger», «not with a bow».']])}
